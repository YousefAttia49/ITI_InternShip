...
route::resource("users",UserController::class); // generate all routes with route name
...
route::resource("products",ProductController::class); // generate all routes with route name


//==================== Orders ===============

route::resource("orders",OrderController::class); // generate all routes with route name
